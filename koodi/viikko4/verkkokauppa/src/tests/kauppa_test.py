...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_saldo(tuote_id):
            ...
            if tuote_id == 2:return 20
            if tuote_id == 3:return 0

        # tehdään toteutus hae_tuote-metodille
        def varasto_hae_tuote(tuote_id):
            if tuote_id == 1:return Tuote(1, "maito", 5)
            if tuote_id == 2:return Tuote(2, "banaani", 3)
            if tuote_id == 3:return Tuote(2, "kolmipyörä", 5000)
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_eri_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_samaa_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_eri_tuotetta_toinen_loppu(self):
